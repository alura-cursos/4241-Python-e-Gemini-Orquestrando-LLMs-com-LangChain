...
from ferramenta_analise_imagem import FerramentaAnaliseImagem
from ferramenta_explicadora import FerramentaExplicadoraAssuntos
...
class AgenteOrquestrador:
    def __init__(self):
        ...
        ferramenta_explicadora = FerramentaExplicadoraAssuntos()
